...
public class TipCalculator {
   /*
    ...
    Your TipCalculator class should have the following methods that calculate and return the values described below; you should RETURN all values -- do not add print statements in your TipCalculator class, all printing should be handled by the code in your main method (as we will learn later, it's best practice to have your program's "logic" in one class, and input/output in another):
